  ...
  return (
    <footer className="relative bg-gradient-to-b from-[#01050d] via-cyan-900 to-cyan-300 backdrop-blur-xl overflow-hidden">
      ...
      <div className="mx-auto max-w-lg px-4 py-16 relative z-10 flex flex-col items-center text-center">
        ...
        {/* Social Media */}
        <div className="mb-12">
          <div className="flex space-x-6 justify-center md:justify-end mt-6 md:mt-0">
            <a href="https://x.com/WiseCoin_" target="_blank" rel="noopener noreferrer" 
              className="text-white hover:brightness-125 transition-all flex items-center justify-center w-10 h-10">
            ...
            <a href="https://www.dextools.io/app/en/ether/pair-explorer/0x8c0849d66ecb8d60a003bdb241ea7b1d7c174b3e?t=1745921649282" target="_blank" rel="noopener noreferrer" 
              className="text-white hover:brightness-125 transition-all flex items-center justify-center w-8 h-8">
              <Image 
                src="/dextools.svg" 
                alt="DexTools" 
                width={16} 
            ...
            <a href="https://dexscreener.com/ethereum/0x8c0849d66ecb8d60a003bdb241ea7b1d7c174b3e" target="_blank" rel="noopener noreferrer" 
              className="text-white hover:brightness-125 transition-all flex items-center justify-center w-8 h-8">
              <Image 
